...
export default function BannerConfigurator() {
  ...
  const debouncedSave = useMemo(
    () =>
      debounce((conf: BannerConfig) => {
        if (JSON.stringify(conf) === JSON.stringify(lastSaved.current)) {
          return;
        }
        fetch(ajaxurl, {
          method: 'POST',
  ...
  return (
    ...
    >
      ...
      <p>
        Let your visitors know they can use Web Monetization to support you. The
        banner only appears to visitors who haven't installed or configured the
        Web Monetization extension. You can disable it anytime by unchecking the
        “Enable banner” option in
        ...
        <div className={cx('main-controls', bgColor)}>
          ...
          <div className="main-controls__right">
            <Select
              ...
              onChange={(value) => value && setDisplayedControl(value)}
            />
          </div>
        </div>
      </div>
      ...
      <div className="wm-form">
        <div className="wm-form-row">
          ...
          <label htmlFor="wm-animation">
            ...
            <select
              ...
              onChange={(e) => setAnimation(e.target.value === 'yes')}
            >
          ...
          <label htmlFor="borderStyle">
            ...
            <select
              ...
              value={borderStyle}
              onChange={(e) =>
                setBorderStyle(e.target.value as 'none' | 'rounded' | 'pill')
              }
            >
        ...
        <div className="wm-form-row">
          ...
          {publishMessage && (
            <p className={`submit status-message status-${publishStatus}`}>
              {publishMessage}
            </p>
          )}
